...
const Datasets = () => (
  <section className="section">
    <Container>
      ...
      <p>SafeBench consists of three datasets: <b>A1</b>, <b>A2</b>, and <b>A3</b>. Each dataset contains three Parquet files: one for positive samples, one for negative samples, and one storing the CPU time for all queries. For example, the A1 dataset includes <b>A1_positive_samples.parquet</b> (MO queries), <b>A1_negative_samples.parquet</b> (non-MO queries), and <b>A1_cputime.parquet</b> (CPU time for all queries). The same structure applies to A2 and A3. The SafeBench datasets can be found <a href="https://www.kaggle.com/datasets/onefanwu/safebench" target="_blank" rel="noopener noreferrer">here</a> at Kaggle. We take the three files from the A1 dataset as examples. The files <b>A1_positive_samples.parquet</b> and <b>A1_negative_samples.parquet</b> store the positive and negative samples, respectively, for the A1 dataset. Both Parquet files share an identical schema, comprising three columns: <code>processid_createtime</code>, <code>instance_name</code>, and <code>feat_vec</code>.</p>
